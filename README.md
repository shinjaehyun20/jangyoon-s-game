...
> 설치 없이 바로 여는, 터치 중심 어린이 미니게임 228개.

[![Games](https://img.shields.io/badge/games-228-6C5CE7)](games.json)
...
[![226개의 게임을 한 곳에서 고르는 장윤이 게임 놀이터](docs/assets/portfolio-hero.svg)](https://shinjaehyun20.github.io/jangyoon-s-game/)
...
<details>
<summary><strong>전체 226개 게임 목록 펼치기</strong></summary>
...
| [⚫⚪ 아기 바둑 (baby-go)](./baby-go) | 9×9 / 13×13 / 19×19에서 돌을 잡고, 남은 돌+둘러싼 빈칸으로 점수를 세는 입문 바둑. 쉬운 바둑말 가이드 포함 | 보드 |
