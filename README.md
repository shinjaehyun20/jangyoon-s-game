...
> 설치 없이 바로 여는, 터치 중심 어린이 미니게임 244개.

[![Games](https://img.shields.io/badge/games-244-6C5CE7)](games.json)
...
[![244개의 게임을 한 곳에서 고르는 장윤이 게임 놀이터](docs/assets/portfolio-hero.svg)](https://shinjaehyun20.github.io/jangyoon-s-game/)
...
<details>
<summary><strong>전체 244개 게임 목록 펼치기</strong></summary>
...
- **⚡ 네온 회로 연결사 · 🐒 정글 덩굴 스윙 타잔 추가 (2026-08-27)** — 터치 회전으로 ⚡발전소에서 🤖로봇까지 전선을 잇는 네온 회로 퍼즐과 진자 물리 반동으로 시원하게 날아가는 정글 스윙 액션 미니게임 2종 추가 (총 236개). 단일 HTML, 외부 CDN 의존성 없음, 100dvh/overflow 보호, Pointer Events 통합 조작.
